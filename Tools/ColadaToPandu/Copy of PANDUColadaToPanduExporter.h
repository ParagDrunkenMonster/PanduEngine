...
namespace Pandu
{
	...
	public:
		...
		static const char* const kColadaVertexDataTypeNames[eCVDS_Count];
		...
		static const char* const kDataElementTypeNames[eDET_Count];
		static const unsigned int kDataElementTypeCountPerElementData[eDET_Count];
	...
	private:
		...
		bool LoadFaces( const TiXmlNode* _triangleNode, unsigned int highestOffset, ColladaGeometry& _oGeometry );
		bool LoadVertices( const TiXmlNode* _meshNode, const TiXmlNode* _verticesNode, ColladaGeometry& _oGeometry );
		void LoadVertexElementData( const TiXmlNode* _meshNode, const char* const _sourceID, ElementSourceData& _oSourceData );
		void LoadVertexSourceData( const TiXmlNode* _arrayNode, ElementSourceData& _oSourceData ) const;
		...
		DataElementType GetDataElementType( const char* const _dataElementTypeName ) const;
		// --------------------------------------------------------
		...
		bool LoadSource( const TiXmlNode* _parentNode,const char* _sourceId, ElementSourceData& _oSourceData ) const;
